...
<div class="container" id="before-slide">
    <div class="product-one">
        <div class="top">
            <a href="#" title="" class="main-title">SÁCH NỔI BẬT</a>
            {{-- <ul class="top__tab">
    ...
    <div class="product-two">
        <div class="top">
            <a href="#" class="main-title">TOP SÁCH BÁN CHẠY</a>
        </div>
        <div class="bot">
...
var routeRenderProductRecently = '{{ route('
ajax_get.product_recently ') }}';
var routeRenderProductByCategory = '{{ route('
ajax_get.product_by_category ') }}';
var routeRenderSlide = '{{ route('
ajax_get.slide ') }}';
